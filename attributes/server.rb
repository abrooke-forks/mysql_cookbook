...
default['mysql']['server_root_password']  = "PASSSWORD_GOES_HERE"
default['mysql']['master_role'] = 'mysql-master'
default['mysql']['slave_role'] = 'mysql-slave'
case node["platform"]
when "centos", "redhat", "fedora", "suse", "scientific", "amazon"
  default['mysql']['server']['packages']      = %w{mysql-server, mysql-devel}
...
when "mac_os_x"
  ...
  default['mysql']['server']['packages']      = %w{mysql-server libmysqld-dev}
  default['mysql']['service_name']            = "mysql"
  default['mysql']['basedir']                 = "/usr"
  default['mysql']['data_dir']                = "/var/lib/mysql"
  default['mysql']['root_group']              = "root"
